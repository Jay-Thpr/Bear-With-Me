import { arrayBufferToBase64, float32ToPcm16Le, resampleFloat32 } from "./pcmUtils";
...
/**
 * Pulls mono PCM from a MediaStream's audio track, resamples to 16 kHz,
 * emits base64 PCM16 LE chunks.
 */
export class MicPcmStreamer {
  ...
  async start(stream: MediaStream): Promise<void> {
    ...
    if (!track) throw new Error("MediaStream has no audio track");
    ...
    // Mute output so we don't hear our own mic
